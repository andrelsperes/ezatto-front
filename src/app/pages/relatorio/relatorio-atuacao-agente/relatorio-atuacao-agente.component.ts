...
import { RelatorioAtuacaoAgenteService } from './relatorio-atuacao-agente.service';
...
@Component({
  selector: 'ngx-relatorio-atuacao-agente',
  templateUrl: './relatorio-atuacao-agente.component.html',
  styleUrls: ['./relatorio-atuacao-agente.component.scss']
})
export class RelatorioAtuacaoAgenteComponent implements OnInit, OnDestroy {

  public formrelatorioAtuacaoAgente = null;
  public rowData = null;
  ...
  constructor(
    ...
    private service: RelatorioAtuacaoAgenteService,
  ...
  ngOnInit() {
    ...
    this.formrelatorioAtuacaoAgente = this.formBuilder.group({
      agente: [null],
    });
    ...
    this.service.buscaInfracao(params, (response => {
      ...
      this.rowData = this.rowData.map((data) => {
        ...
        return {
          ...
          //codMunicipio: data.municipio.codMunicipio,
          //descricaoCidade: data.municipio.descricao,
          //descricaoUF: data.municipio.uf.descricao,
          nrKm: data.nrKm,
      ...
      if (this.exportar == 0) {
        ...
        this.exportCsvService.exportCsv(this.rowData, this.columnsTabe, ',', 'atuacaoAgente');
      }
      console.log(this.rowData)
