...
import { RelatorioInfracaoMensalService } from './relatorio-infracao-mensal.service';
...
@Component({
  selector: 'ngx-relatorio-infracao-mensal',
  templateUrl: './relatorio-infracao-mensal.component.html',
  styleUrls: ['./relatorio-infracao-mensal.component.scss']
})
export class RelatorioInfracaoMensalComponent implements OnInit, OnDestroy {

  public formrelatorioInfracaoMensal = null;
  public rowData = null;
 ...
 public columnsTabe = null;
  ...
  constructor(
    ...
    private service: RelatorioInfracaoMensalService,
  ...
  ngOnInit() {
    ...
    this.formrelatorioInfracaoMensal = this.formBuilder.group({
      dataInicio: [null],
      dataFim: [null],
    });
